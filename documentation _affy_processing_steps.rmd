...
|Oligo|3.15.0|[https://www.bioconductor.org/packages/release/bioc/html/oligo.html](https://www.bioconductor.org/packages/release/bioc/html/oligo.html)|
...
### 1a. Package for Reading Raw Data Files  
...
- `[""]` – Retrieves column from dataframe with the specified column name
...
- list (paths to raw data files)

<br>

### 2c. Read Raw Data Files  
...
- `()` - name of list of paths to data files
...
- GeneExpressionSet (read raw data)
